...
MODEL_NAME = 'numplate'
PATH_TO_CKPT = MODEL_NAME + '/graph/frozen_inference_graph.pb'
...
cv2.imwrite('crop.jpg',img_data) 

cv2.imshow('Object detector', image_np)
cv2.imshow('Number Plate',img_data)  
